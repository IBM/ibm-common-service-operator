...
import (
	...
	commonservicewebhook "github.com/IBM/ibm-common-service-operator/v4/internal/controller/webhooks/no-olm/commonservice"
	operandrequestwebhook "github.com/IBM/ibm-common-service-operator/v4/internal/controller/webhooks/no-olm/operandrequest"
...
type WebhookReconciler interface {
	...
	Reconcile(ctx context.Context, client client.Client, caBundle []byte) error
}
...
func (reconciler *CompositeWebhookReconciler) Reconcile(ctx context.Context, client client.Client, caBundle []byte) error {
	for _, innerReconciler := range reconciler.Reconcilers {
...
func (reconciler *MutatingWebhookReconciler) Reconcile(ctx context.Context, client client.Client, caBundle []byte) error {
	var (
...
func (reconciler *ValidatingWebhookReconciler) Reconcile(ctx context.Context, client client.Client, caBundle []byte) error {
	var (
		sideEffects    = admissionregistrationv1.SideEffectClassNone
		port           = int32(servicePort)
		matchPolicy    = admissionregistrationv1.Exact
