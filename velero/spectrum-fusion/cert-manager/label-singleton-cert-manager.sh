...
function label_catalogsource() {
    ...
    ${OC} label catalogsource "$CM_SOURCE" foundationservices.cloudpak.ibm.com=cert-manager -n "$CM_SOURCE_NS" --overwrite=true 2>/dev/null
    echo ""
}
...
function label_ns_and_related() {
    ...
    ${OC} label namespace "$CERT_MANAGER_NAMESPACE" foundationservices.cloudpak.ibm.com=cert-manager --overwrite=true 2>/dev/null
    ...
    ${OC} label operatorgroup "$operator_group" foundationservices.cloudpak.ibm.com=cert-manager -n "$CERT_MANAGER_NAMESPACE" --overwrite=true 2>/dev/null
