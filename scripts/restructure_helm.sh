...
sed -i 's/{{ .Values.imagePullPrefix }}:{{ .Values.imageRegistryNamespaceOperator }}:{{ .Values.operatorImage }}:{{ .Values.operatorVersion }}/{{ .Values.imagePullPrefix }}\/{{ .Values.imageRegistryNamespaceOperator }}\/{{ .Values.operatorImage }}:{{ .Values.operatorVersion }}/g' $HELM_DIR/templates/operator-deployment.yaml
