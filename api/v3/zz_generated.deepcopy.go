...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CatalogPlane) DeepCopyInto(out *CatalogPlane) {
	*out = *in
	if in.NonDefaultCRstatus != nil {
		in, out := &in.NonDefaultCRstatus, &out.NonDefaultCRstatus
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CatalogPlane.
func (in *CatalogPlane) DeepCopy() *CatalogPlane {
	if in == nil {
		return nil
	}
	out := new(CatalogPlane)
	in.DeepCopyInto(out)
	return out
}
...
func (in *ConfigStatus) DeepCopyInto(out *ConfigStatus) {
	*out = *in
	in.ServicesPlane.DeepCopyInto(&out.ServicesPlane)
	in.OperatorPlane.DeepCopyInto(&out.OperatorPlane)
	in.CatalogPlane.DeepCopyInto(&out.CatalogPlane)
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OperatorPlane) DeepCopyInto(out *OperatorPlane) {
	*out = *in
	if in.NonDefaultCRstatus != nil {
		in, out := &in.NonDefaultCRstatus, &out.NonDefaultCRstatus
		*out = make(map[string]OperatorNamespace, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OperatorPlane.
func (in *OperatorPlane) DeepCopy() *OperatorPlane {
	if in == nil {
		return nil
	}
	out := new(OperatorPlane)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServicesPlane) DeepCopyInto(out *ServicesPlane) {
	*out = *in
	if in.NonDefaultCRstatus != nil {
		in, out := &in.NonDefaultCRstatus, &out.NonDefaultCRstatus
		*out = make(map[string]ServicesNamespace, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServicesPlane.
func (in *ServicesPlane) DeepCopy() *ServicesPlane {
	if in == nil {
		return nil
	}
	out := new(ServicesPlane)
	in.DeepCopyInto(out)
	return out
}
