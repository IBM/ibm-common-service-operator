...
The provided script installs all the YAML definition of NetworkPolicies (including _deny-all_ Policy) in the current folder, to validate Bedrock works end-to-end in the restricted network traffic scenario.
