...
function print_usage() {
    ...
    echo ""
    echo "De-activate IBM Cloud Pak 2.0 Cert Manager Certificate Management."
    echo "The --operator-namespace must be provided."
    echo ""
    echo "Options:"
    echo "   --oc string                    File path to oc CLI. Default uses oc in your PATH"
    echo "   --control-namespace string     Required. Namespace to install Cloud Pak 2.0 Cert Manager services."
